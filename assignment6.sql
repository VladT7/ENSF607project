...
INSERT INTO Course (capacity, end_time, has_prerequisite, id, name, start_time)
VALUES
(5,25,"2022-11-04",1,"ENSF612","2022-11-01"),
(4,20,"2022-11-04",1,"ENSF611","2022-11-01");


DROP TABLE IF EXISTS STUDENT;
CREATE TABLE STUDENT (
	id						bigint not null, #i dont know what this id is supposed to be
    password				varchar(255),
    ucid					varchar(255),
    username				varchar(255),
    DOB						date, #ours that we created
...
VALUES
(1234, "monkey", "10120392", "John Smith", "1999-12-02"),
(6789, "turtle", "38492018", "Cindy Lu", "1995-04-08");


DROP TABLE IF EXISTS STUDENT_ENROLLED;
CREATE TABLE STUDENT_ENROLLED(
	course_id				bigint, #what we have is offering_id, don't know if you guys want to change it, if so go ahead
    student_id 				bigint,
    grade					varchar(225), #ours, also how about boolean?
    offering_id				bigint, #ours but do we need it?
...
VALUES
("ENSF 592", "Mohammad Moshirpour", "SP"), #SP is for spring. F = Fall, W = Winter, SP = Spring, SU = Summer
